...
const EVENTS: EventItem[] = [
  {
    key: "order_otp",
    label: "ফোন ভেরিফিকেশন ওটিপি (Checkout OTP)",
    desc: "চেকআউট বা ফ্রড প্রোটেকশনে ৪-ডিজিটের ভেরিফিকেশন কোড এসএমএস",
    category: "checkout",
    smsSupported: true,
  ...
  {
    key: "abandoned_cart",
    label: "অসম্পূর্ণ চেকআউট রিকভারি (Abandoned Cart)",
    desc: "কার্ট বা চেকআউট অসমাপ্ত রাখলে ডিসকাউন্ট লিংকসহ রিকভারি এসএমএস",
    category: "checkout",
    smsSupported: true,
  ...
  {
    key: "order_placed",
    label: "অর্ডার গ্রহণ ও কনফার্মেশন (Order Placed)",
    desc: "ক্যাশ অন ডেলিভারি (COD) বা বিকাশ/অনলাইন পেমেন্ট নিশ্চিত হলে অর্ডার আইডি ও ট্র্যাকিং লিংকসহ এসএমএস",
    category: "orders",
    smsSupported: true,
    smsNote: "Automated SMS Gateway",
    whatsappSupported: true,
  ...
  {
    key: "order_shipped",
    label: "কুরিয়ারে হস্তান্তর ও ট্র্যাকিং (Consignment Shipped)",
    desc: "স্টিভফাস্ট বা পাঠাও-এ বুকিং হলে ট্র্যাকিং কোড ও লাইভ ট্র্যাকিং লিংকসহ গ্রাহককে এসএমএস",
    category: "orders",
    smsSupported: true,
  ...
  },
  {
    ...
    label: "অগ্রিম ডেলিভারি চার্জ অনুরোধ (Advance Delivery Charge)",
    desc: "ঢাকার বাইরের অর্ডারে ডেলিভারি চার্জ অগ্রিম বিকাশে পাঠানোর এসএমএস অনুরোধ",
    category: "orders",
    smsSupported: true,
  ...
  {
    key: "order_delivered",
    label: "ডেলিভারি সম্পন্ন নিশ্চিতকরণ (Order Delivered)",
    desc: "কুরিয়ার থেকে ডেলিভারি সম্পন্ন হলে ধন্যবাদ ও ডেলিভারি কনফার্মেশন এসএমএস",
    category: "orders",
    smsSupported: true,
    smsNote: "Automated SMS Gateway",
    whatsappSupported: false,
  ...
  {
    key: "order_cancelled",
    label: "অর্ডার বাতিল সংক্রান্ত তথ্য (Order Cancelled)",
    desc: "অর্ডার বাতিল হলে বা কাস্টমার অনুরোধে ক্যানসলেশন এসএমএস",
    category: "orders",
    smsSupported: true,
    smsNote: "Automated SMS Gateway",
    whatsappSupported: false,
  ...
  {
    key: "refund_approved",
    label: "রিফান্ড ও রিটার্ন অনুমোদিত (Refund Approved)",
    desc: "প্রোডাক্ট রিটার্ন যাচাই শেষে টাকা ফেরত বা ভাউচার প্রদান সংক্রান্ত এসএমএস",
  ...
  {
    key: "review_request",
    label: "প্রোডাক্ট রিভিউ ও ফিডব্যাক অনুরোধ (Review Request)",
    desc: "ডেলিভারির ২-৩ দিন পর মূল্যবান মতামত ও রিভিউ প্রদানের এসএমএস অনুরোধ",
    category: "post_delivery",
    smsSupported: true,
  ...
  {
    key: "promotional",
    label: "রিস্টক ও প্রমোশনাল অফার (Promotional & Replenishment)",
    desc: "স্কিনকেয়ার রিফিল রিমাইন্ডার এবং বিশেষ কুপন কোড সংক্রান্ত এসএমএস",
    category: "post_delivery",
    smsSupported: true,
  ...
  {
    key: "password_reset",
    label: "পাসওয়ার্ড রিসেট ও একাউন্ট ওটিপি (Password Reset)",
    desc: "গ্রাহক পাসওয়ার্ড ভুলে গেলে ইনস্ট্যান্ট সিকিউরিটি ওটিপি এসএমএস",
    category: "auth",
    smsSupported: true,
    smsNote: "Automated SMS Gateway",
    whatsappSupported: false,
