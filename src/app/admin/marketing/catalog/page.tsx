  ...
  const feeds = [
    {
      ...
      requiredFields: [
        ...
        "gtin (barcode)",
        "inventory (qty)",
        "shipping (BD:Standard:60 BDT)",
        "custom_label_0 (Origin)",
        "custom_label_1 (Featured)",
        "custom_label_2 (Price Tier)",
        "custom_label_3 (Stock Readiness)",
        "custom_label_4 (On Sale)",
      ],
    },
    {
      id: "tiktok",
      ...
      requiredFields: [
        ...
        "custom_label_2 (Price Tier)",
        "custom_label_3 (Stock Level)",
        "custom_label_4 (Deal Status)",
      ],
    },
    {
      id: "google",
      ...
      requiredFields: [
        ...
        "g:gtin (barcode)",
        "g:shipping_weight",
        "g:shipping (BD Standard)",
        "g:adult (no)",
        "g:gender (unisex)",
        "g:age_group (adult)",
        "g:custom_label_0 (Origin)",
        "g:custom_label_1 (Featured)",
        "g:custom_label_2 (Price Tier)",
        "g:custom_label_3 (Stock Readiness)",
        "g:custom_label_4 (On Sale)",
      ],
    },
  ];
