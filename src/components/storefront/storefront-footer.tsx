...
export function StorefrontFooter({ config: initialConfig }: { config?: HomepageFullConfig }) {
  ...
  const paymentBadgeImages = fc.paymentBadgeImages || {};
  const customPaymentBadges = (fc.customPaymentBadges || []).filter((b) => b.enabled !== false && b.imageUrl);
  ...
  const hasQuizLink = rawCareLinks.some(
    (l) => l.href === "/quiz" || l.href?.toLowerCase().includes("quiz") || l.label?.toLowerCase().includes("routine")
  );

  const customerCareLinks = hasQuizLink
    ? rawCareLinks
    : [
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  {fc.socialLinks.facebook && (
                    <a
                      ...
                      aria-label="Facebook"
                      title="Facebook"
                      className="group flex h-10 w-10 items-center justify-center rounded-2xl bg-[#1877F2] text-white shadow-md shadow-[#1877F2]/25 hover:scale-110 hover:shadow-lg hover:shadow-[#1877F2]/40 active:scale-95 transition-all duration-200"
                    >
                  ...
                  {fc.socialLinks.instagram && (
                    <a
                      ...
                      title="Instagram"
                      className="group flex h-10 w-10 items-center justify-center rounded-2xl bg-linear-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white shadow-md shadow-[#dc2743]/25 hover:scale-110 hover:shadow-lg hover:shadow-[#dc2743]/40 active:scale-95 transition-all duration-200"
                    >
                      <svg className="h-5 w-5 fill-white" viewBox="0 0 24 24">
                  ...
                  {fc.socialLinks.youtube && (
                    <a
                      ...
                      aria-label="YouTube"
                      title="YouTube"
                      className="group flex h-10 w-10 items-center justify-center rounded-2xl bg-[#FF0000] text-white shadow-md shadow-[#FF0000]/25 hover:scale-110 hover:shadow-lg hover:shadow-[#FF0000]/40 active:scale-95 transition-all duration-200"
                    >
                      <svg className="h-5 w-5 fill-white" viewBox="0 0 24 24">
                  ...
                  {fc.socialLinks.whatsapp && (
                    <a
                      ...
                      aria-label="WhatsApp"
                      title="WhatsApp"
                      className="group flex h-10 w-10 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-md shadow-[#25D366]/25 hover:scale-110 hover:shadow-lg hover:shadow-[#25D366]/40 active:scale-95 transition-all duration-200"
                    >
                      <svg className="h-5 w-5 fill-white" viewBox="0 0 24 24">
                  ...
                  {fc.socialLinks.tiktok && (
                    <a
                      ...
                      aria-label="TikTok"
                      title="TikTok"
                      className="group flex h-10 w-10 items-center justify-center rounded-2xl bg-[#010101] border border-zinc-800 text-white shadow-md shadow-black/40 hover:scale-110 hover:border-zinc-600 active:scale-95 transition-all duration-200"
                    >
                      <svg className="h-5 w-5" viewBox="0 0 24 24">
                        <path
                          d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.004-.004A2.894 2.894 0 0 1 9.47 12.77c.3-.002.597.042.88.13V9.398a6.332 6.332 0 0 0-1-.08 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 10.86 4.46V10.7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.051-.134z"
                          fill="#25F4EE"
              ...
              <div className="pt-4 border-t border-zinc-800">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {acceptedPayments.bkash && (
                    <div
                      className="flex h-8 w-14 sm:h-9 sm:w-16 shrink-0 items-center justify-center rounded-xl bg-white px-1.5 py-1 shadow-xs border border-white/20 hover:scale-105 hover:shadow-md transition-all select-none overflow-hidden"
                      title="bKash"
                    >
                      {paymentBadgeImages.bkash ? (
                        <img
                          src={paymentBadgeImages.bkash}
                          alt="bKash"
                          className="h-full w-full max-h-6 sm:max-h-7 object-contain mx-auto select-none"
                        />
                      ) : (
                  ...
                  {acceptedPayments.nagad && (
                    <div
                      ...
                      title="Nagad"
                    >
                      {paymentBadgeImages.nagad ? (
                        <img
                          src={paymentBadgeImages.nagad}
                          alt="Nagad"
                          className="h-full w-full max-h-6 sm:max-h-7 object-contain mx-auto select-none"
                        />
                      ) : (
                  ...
                  {acceptedPayments.visa && (
                    <div
                      ...
                      title="Visa"
                    >
                      {paymentBadgeImages.visa ? (
                        <img
                          src={paymentBadgeImages.visa}
                          alt="VISA"
                          className="h-full w-full max-h-6 sm:max-h-7 object-contain mx-auto select-none"
                        />
                      ) : (
                        <span className="text-xs sm:text-sm font-black italic tracking-wider text-[#1a1f71] leading-none select-none">
                          VISA
                        </span>
                      )}
                    </div>
                  ...
                  {acceptedPayments.mastercard && (
                    <div
                      ...
                      title="Mastercard"
                    >
                      {paymentBadgeImages.mastercard ? (
                        <img
                          src={paymentBadgeImages.mastercard}
                          alt="Mastercard"
                          className="h-full w-full max-h-6 sm:max-h-7 object-contain mx-auto select-none"
                        />
                      ) : (
                  ...
                  {acceptedPayments.amex && (
                    <div
                      className={cn(
                        "flex h-8 w-14 sm:h-9 sm:w-16 shrink-0 items-center justify-center rounded-xl px-1.5 py-1 shadow-xs hover:scale-105 hover:shadow-md transition-all select-none overflow-hidden",
                        paymentBadgeImages.amex
                          ? "bg-white border border-white/20"
                          : "bg-[#016fd0] border border-blue-400/30"
                      )}
                      title="American Express"
                    >
                      {paymentBadgeImages.amex ? (
                        <img
                          src={paymentBadgeImages.amex}
                          alt="AMEX"
                          className="h-full w-full max-h-6 sm:max-h-7 object-contain mx-auto select-none"
                        />
                      ) : (
                        <span className="text-[9px] sm:text-[10px] font-black uppercase text-white tracking-tighter leading-none select-none">
                          AMEX
                        </span>
                      )}
                    </div>
                  ...
                  {acceptedPayments.cod && (
                    ...
                    >
                      {paymentBadgeImages.cod ? (
                        <img
                          src={paymentBadgeImages.cod}
                  ...
                  {/* Custom Uploaded Payment Badges (e.g. Rocket, Upay, SSLCommerz, etc.) */}
                  {customPaymentBadges.map((badge, idx) => (
                    <div
                      key={badge.id || `custom-badge-${idx}`}
                      className="flex h-8 w-14 sm:h-9 sm:w-16 shrink-0 items-center justify-center rounded-xl bg-white px-1.5 py-1 shadow-xs border border-white/20 hover:scale-105 hover:shadow-md transition-all select-none overflow-hidden"
                      title={badge.name}
                    >
                      <img
