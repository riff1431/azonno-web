...
export function StorefrontMaintenanceScreen({
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-rose-50/60 via-white to-pink-50/40 flex flex-col justify-between selection:bg-rose-100">
      {/* Admin Quick Action Banner if logged in as Admin */}
      {isAdminUser && (
        <div className="bg-slate-900 text-white px-4 py-2.5 text-xs shadow-md border-b border-slate-800 z-50 sticky top-0">
          <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-amber-400 animate-pulse" />
              <span className="font-semibold text-gray-200">
                <strong>Administrator Access:</strong> Storefront is currently <strong>OFFLINE</strong> to all public visitors.
              </span>
            </div>
            <div className="flex items-center gap-2">
              <a
                href="/?admin_preview=1"
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-xs shadow-xs transition"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-gray-200 text-xs font-semibold border border-slate-700 transition"
              >
      ...
      {/* Top Header */}
      <div className="max-w-6xl mx-auto w-full p-6 md:p-12 pb-0 md:pb-0 flex items-center justify-between">
      ...
      {/* Hero Center Card */}
      <div className="max-w-2xl mx-auto text-center my-auto py-12 px-6 space-y-6">
      ...
      {/* Footer info */}
      <div className="max-w-6xl mx-auto w-full p-6 md:p-12 pt-8 border-t border-gray-200/60 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left text-xs text-gray-500">
